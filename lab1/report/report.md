...
![data-schema](pictures/olist_dataset_schema.png)
...
- Метрики: F1 (основная при дисбалансе классов), ROC-AUC, Precision, Recall.
...
Объекты в бакете `data-lake` (веб-консоль MinIO):
...
- `response_hours` почти не различает довольных и недовольных клиентов: медианные значения близки, около 39.3 и 40.4 часов. Поэтому этот признак оставили как дополнительный, а не как один из основных.
